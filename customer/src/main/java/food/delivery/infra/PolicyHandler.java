...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='OrderAceepted'")
    public void wheneverOrderAceepted_Notify(@Payload OrderAceepted orderAceepted){

        OrderAceepted event = orderAceepted;
        System.out.println("\n\n##### listener Notify : " + orderAceepted + "\n\n");
