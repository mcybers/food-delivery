...
public class MyPageViewHandler {
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenOrderAceepted_then_UPDATE_2(@Payload OrderAceepted orderAceepted) {
        try {
            if (!orderAceepted.validate()) return;
                // view 객체 조회
            Optional<MyPage> myPageOptional = myPageRepository.findById(Long.valueOf(orderAceepted.getOrderId()));
